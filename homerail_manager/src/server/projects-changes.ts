...
function _projectInput(body: Record<string, unknown>): {
  ...
  return {
    ...
    git_server_id: body.git_server_id === null || body.git_server_id === "" ? "" : _trimmedString(body.git_server_id) ?? _trimmedString(body.gitServerId),
    git_repository: body.git_repository === null || body.git_repository === "" ? "" : _gitRepositoryFromBody(body),
    git_branch: body.git_branch === null || body.git_branch === "" ? "" : _trimmedString(body.git_branch) ?? _trimmedString(body.gitBranch),
